...
An child theme that transforms the homepage of `https://qrspace.cam` into the QRSpace dark-mode landing page, without affecting the rest of the site (blog, products, cart, checkout, my account), which continues to use WordPress + WooCommerce with Astra styles.
